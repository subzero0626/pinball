...
const CONFIG = {
  ...
  /* --- 라운드 / 드롭 --- */
  dropsPerRound: 3,
  roundTargets: [12, 54, 218, 594, 1760, 4500, 13000, 35000, 95000, 250000],
  ...
  spawnFlashMs: 200,
  invalidFlashMs: 400,
  /** 마지막 공 종료 후 막대 고르기/클리어까지 대기 (0 = 즉시) */
  dropEndDelayMs: 0,
};
...
const BAR_TIPS = {
  ...
  chaos_warp: '공이 지나가면 보드 위 랜덤한 곳으로 이동합니다. (공당 1회)\n일반 워프와 별개로 사용할 수 있습니다.',
  growth: '구매 시점 ×0.7부터 시작.\n드롭이 끝날 때마다 ×가 0.1씩 커집니다.',
  glass: '점수가 ×2.4가 되지만, 종료 구역에서 50% 확률로 깨집니다.\n깨지면 점수가 없고 깨짐! 만 표시됩니다.\n유리화된 공은 반투명하게 보입니다.',
};
